...
- Replace the selected inline fixed-record memory with records populated by the real font-download parser, then replace producer-modeled text bucket fixtures with full parser-produced page-object payloads.

...
- Replace the synthetic direct control-code cursor/page fixtures with parser-driven byte-stream fixtures, then use those plus raster start/transfer behavior to finish naming cursor coordinate variables `0x782c8a` and `0x782c8e`.

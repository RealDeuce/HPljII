...
3. Replace the modeled `0x1ab84` synthesized default-font search with a live parser/font-state fixture that proves the real candidate records feeding `0x1b250`, `0x1b50e`, `0x1bbfe`, and `0x1b060`, and decide how to document the undocumented but parser-exposed `@0..@2` table/copy variants.

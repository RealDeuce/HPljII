...
- Broaden the narrow direct-control and one-byte printable stream fixtures into the full firmware parser path and replace synthetic `ESC E` fixtures with parser-produced page-object fixtures.
...
- Broaden the documented one-byte `0x1393a` / `0xd824` / `0x12f2e` text-object glyph-index fixture into realistic selected-context longwords, glyph indices, and parser-produced page objects.

...
3. Replace the modeled `0x1b250` / `0x1ab84` / `0x1ad66` default-font candidate searches with a live parser/font-state fixture, and decide how to document the undocumented but parser-exposed `@0..@2` table/copy variants.

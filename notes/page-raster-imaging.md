...
verifies 351 checks. The raster coverage now includes ROM-table
...
before wide glyph rendering and now crosses `0x1edc6` before rendering
the same wide row. The fetched `ESC )s2193W` downloaded-pointer object

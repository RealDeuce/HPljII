...
| Message | Meaning |
| --- | --- |
| `42 ERROR` | Optional interface communication problem; press continue, reseat optional I/O PCA. |
...
| Message | Meaning |
| --- | --- |
| `50 SERVICE` | Fuser malfunction. Power off at least 10 minutes, then troubleshoot fuser. |

...
3. Replace the modeled `0x1b250` / `0x1ab84` default-font searches and `0x1bbfe` / `0x1b060` helper-return boundary with a live parser/font-state fixture, and decide how to document the undocumented but parser-exposed `@0..@2` table/copy variants.

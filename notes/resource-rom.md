...
4. Replace the synthetic short text bucket object fixture with real parser-produced page-object payloads and broaden coverage beyond the four current mode-1 built-in examples.

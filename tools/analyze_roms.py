...
def font_context_bridge_report(data: bytes) -> str:
    ...
    lines.append("| `0x14c64` | selected font object dispatcher | if no matching active object exists, reads `0x7828a8`; bit-30 built-ins update `0x783134`/`0x78313a` range words and `0x783132`/`0x783133` flags before `0x14d9c`, while inline/downloaded records call `0x14e24`; both paths then call `0x14f16` and `0x1440c` |")

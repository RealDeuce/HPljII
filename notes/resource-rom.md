...
3. Replace the modeled `0x1be22` `@3` default-font path with a live parser/font-state fixture, and decide how to document the undocumented but parser-exposed `@0..@2` table/copy variants.

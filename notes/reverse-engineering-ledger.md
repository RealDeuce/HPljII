...
- Integrate decoded real glyph-row fixtures with complete row-copy/page-object rendering.
...
- Broaden `tools/render_fixture_harness.py` beyond the three current decoded mode-1 built-in glyph-row fixtures.

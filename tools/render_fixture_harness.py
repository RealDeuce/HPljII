...
def run_selftest(data: bytes, resources: bytes) -> list[str]:
    ...
    checks.append(assert_equal("symbol-set parser trace covers X and @ special cases", {
        ...
        "model_events": [
            {
                "sequence": b"\x1b(7X",
                "record": b"\x80X\x00\x07\x00\x00",
                "slot": 0,
                "setup_handler": 0x01201E,
                "terminal_handler": 0x0120BE,
                "dispatch_target": 0x01C066,
                "parameter": 7,
                "final": ord("X"),
                "kind": "font-id",
            ...
            {
                "sequence": b"\x1b)0@",
                "record": b"\x80@\x00\x00\x00\x01",
                "slot": 1,
                "setup_handler": 0x012008,
                "terminal_handler": 0x0120BE,
                "dispatch_target": 0x01BED4,
                "parameter": 0,
                "final": ord("@"),
                "kind": "default-table-slot",
            ...
            {
                "sequence": b"\x1b(1@",
                "record": b"\x80@\x00\x01\x00\x00",
                "slot": 0,
                "setup_handler": 0x01201E,
                "terminal_handler": 0x0120BE,
                "dispatch_target": 0x01BF0A,
                "parameter": 1,
                "final": ord("@"),
                "kind": "default-table-primary",
                "previous_word": 0x0055,
            ...
            {
                "sequence": b"\x1b)2@",
                "record": b"\x80@\x00\x02\x00\x01",
                "slot": 1,
                "setup_handler": 0x012008,
                "terminal_handler": 0x0120BE,
                "dispatch_target": 0x01BF36,
                "parameter": 2,
                "final": ord("@"),
            ...
            {
                "sequence": b"\x1b(3@",
                "record": b"\x80@\x00\x03\x00\x00",
                "slot": 0,
                "setup_handler": 0x01201E,
                "terminal_handler": 0x0120BE,
                "dispatch_target": 0x01BF74,
                "parameter": 3,
                "final": ord("@"),
                "kind": "default-font",
                "previous_word": 0x0055,
        ...
        "requested_symbols": [0x02C1, 0x02C1],
        "active_symbols": [0x02C1, 0x02C1],
    ...
    checks.append(assert_equal("LF parser trace feeds page-record queue", {
        ...
        "parser_events": [
            {"kind": "command", "handler": 0x00EDF8, "mode_after": 0},
            {"kind": "printable", "handler": 0x00D04A, "mode_after": 0},
            {"kind": "control", "handler": 0x00F08C, "mode_after": 0},
            {"kind": "printable", "handler": 0x00D04A, "mode_after": 0},
        ],
        "parser_final_mode": 0,
        "events": [
            {"kind": "escape", "sequence": b"\x1b&k2G", "line_termination": 0x60},
            {
                "kind": "printable",
                "byte": 0x21,
                "cursor_before": pack12(10),
    ...
    checks.append(assert_equal("HT/BS parser trace feeds page-record queue", {
        ...
        "parser_events": [
            {"kind": "command", "handler": 0x00EDF8, "mode_after": 0},
            {"kind": "control", "handler": 0x00F1CC, "mode_after": 0},
            {"kind": "control", "handler": 0x00F2A8, "mode_after": 0},
            {"kind": "printable", "handler": 0x00D04A, "mode_after": 0},
        ],
        "parser_final_mode": 0,
        "events": [
            {"kind": "escape", "sequence": b"\x1b&k0G", "line_termination": 0},
            {
                "kind": "control",
                "byte": 0x09,
                "cursor_before": (pack12(17), pack12(21)),
                "cursor_after": (pack12(21), pack12(21)),
                "page_roots": 0,
                "span_flushes": 0,
            },
            {
                "kind": "control",
                "byte": 0x08,
                "cursor_before": (pack12(21), pack12(21)),
                "cursor_after": (pack12(20), pack12(21)),
                "page_roots": 0,
                "span_flushes": 0,
            },
            {
    ...
    checks.append(assert_equal("chained margin command parser trace feeds page-record queue", {
        ...
        "stream": b"\x1b&a6l9M!",
        "parser_events": [
            {"kind": "command", "handler": 0x00EB58, "mode_after": 12},
            {"kind": "control", "handler": None, "mode_after": 12},
            {"kind": "control", "handler": 0x00EC0C, "mode_after": 0},
            {"kind": "printable", "handler": 0x00D04A, "mode_after": 0},
        ],
        "parser_final_mode": 0,
        "events": [
            {
                ...
                "right_margin": pack12(300),
                "events": [
                    {"kind": "left-margin-cursor-move", "cursor_x": pack12(108)},
                    {"kind": "left-margin", "margin": pack12(108)},
                ],
                "chained": True,
            },
            {
                ...
                "events": [
                    {"kind": "right-margin", "margin": pack12(180)},
                ],
                "chained": False,
            },
            {
    ...
    checks.append(assert_equal("horizontal decipoint parser trace feeds page-record queue", {
        ...
        "stream": b"\x1b&a72H!",
        "parser_events": [
            {"kind": "command", "handler": 0x00F416, "mode_after": 0},
            {"kind": "printable", "handler": 0x00D04A, "mode_after": 0},
        ],
        "parser_final_mode": 0,
        "events": [
            {
                "kind": "cursor-position",
                "sequence": b"\x1b&a72H",
                "record": bytes.fromhex("80 48 00 48 00 00"),
                "parameter": 72,
                "fraction": 0,
                "relative": False,
                "handler": 0x00F416,
    ...
    checks.append(assert_equal("chained cursor position parser trace feeds page-record queue", {
        ...
        "stream": b"\x1b&a2c+1R!",
        "parser_events": [
            {"kind": "command", "handler": 0x00F39E, "mode_after": 12},
            {"kind": "control", "handler": None, "mode_after": 12},
            {"kind": "control", "handler": None, "mode_after": 12},
            {"kind": "control", "handler": 0x00F560, "mode_after": 0},
            {"kind": "printable", "handler": 0x00D04A, "mode_after": 0},
        ],
        "parser_final_mode": 0,
        "events": [
            {
                "kind": "cursor-position",
                "sequence": b"\x1b&a2c",
                "record": bytes.fromhex("80 63 00 02 00 00"),
                "parameter": 2,
                "fraction": 0,
                "relative": False,
                "handler": 0x00F39E,
                "cursor_before": {"x": pack12(10), "y": pack12(20)},
                "cursor_after": {"x": pack12(36), "y": pack12(20)},
                "event": {"kind": "horizontal-position", "relative": False, "amount": pack12(36), "cursor_x": pack12(36)},
                "chained": True,
            },
            {
                ...
                "relative": True,
                "handler": 0x00F560,
                "cursor_before": {"x": pack12(36), "y": pack12(20)},
                "cursor_after": {"x": pack12(36), "y": pack12(70)},
                "event": {"kind": "vertical-position", "relative": True, "amount": pack12(50), "cursor_y": pack12(70), "clamp_max": False},
                "chained": False,
            },
            {
                "kind": "printable",
    ...
    checks.append(assert_equal("vertical layout parser trace feeds page-record queue", {
        ...
        "stream": b"\x1b&l3E!",
        "parser_events": [
            {"kind": "command", "handler": 0x00ECE2, "mode_after": 0},
            {"kind": "printable", "handler": 0x00D04A, "mode_after": 0},
        ],
        "parser_final_mode": 0,
        "events": [
            {
                "kind": "vertical-layout",
                "sequence": b"\x1b&l3E",
                "record": bytes.fromhex("80 45 00 03 00 00"),
                "parameter": 3,
                "fraction": 0,
                "relative": False,
                "handler": 0x00ECE2,
    ...
    checks.append(assert_equal("mixed printable/page-size page-record finalization publishes bridged record", {
    ...
    lines.append("- LF parser-to-page-record boundary: stream `1b 26 6b 32 47 21 0a 21` routes `ESC &k2G` through handler `0xedf8`, the first printable `!` through `0xd04a`, LF through `0xf08c`, and the second printable `!` through `0xd04a`; LF applies CR+LF before the second glyph, queueing compact coord `0x3b00` and rendering the same post-CR rows.")
    lines.append("- HT/BS parser-to-page-record boundary: stream `1b 26 6b 30 47 09 08 21` routes `ESC &k0G` through handler `0xedf8`, HT through `0xf1cc`, BS through `0xf2a8`, and printable `!` through `0xd04a`; HT advances the cursor to x `21`, BS backs it up to x `20`, then the bridged glyph queues at compact coord `0x0a01` and renders at pixel x `26`.")
    ...
    lines.append("- chained-margin parser-to-page-record boundary: stream `1b 26 61 36 6c 39 4d 21` routes lowercase-final `ESC &a6l` through handler `0xeb58`, keeps parser mode `12` for `9M` through handler `0xec0c`, then queues printable `!` through `0xd04a` at compact coord `0x0207` and renders the bridged glyph at pixel x `114`.")

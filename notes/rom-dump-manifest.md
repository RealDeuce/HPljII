...
The verified ROM images are local-only artifacts and are intentionally ignored by Git. Track filenames, hashes, package locations, read method, and analysis notes here; keep raw bytes in the working directory.
...
| Board | Chip marking | Local filename | SHA-256 | Evidence |
| --- | --- | --- | --- | --- |
...
| IC30 | SH7-9235-0100 | `ic30_sh7-9235-0100_tc531000p.bin` | `63959a0ad8a4185f6a127afa23dfc89b1f0d7dd04a2a84da853abb30ffd1aeb6` | three reads matched; ROM tail marker `SH7-9235-01000` |
...
| Pair | Byte order | Local output | SHA-256 | Interpretation |
| --- | --- | --- | --- | --- |
| firmware | IC30, IC13 | `generated/roms/ic30_ic13.bin` | `feeaf8d651b593af72b65d76fe6b85ee7d191278570438caeac49e0b74dbd079` | 68000 executable ROM pair |
| resources | IC32, IC15 | `generated/roms/ic32_ic15.bin` | `dd4ca68e1790dc81dfdb4c364a0bc5e449f4c53e1bfc39a1536c26369eab935c` | resource/font/data ROM pair |
...
Disassembling at `0x00000110` as `m68000` produces coherent startup code: interrupt mask setup, `RESET`, hardware register writes, RAM tests, trampoline initialization, and jumps into later initialization routines.
...
MAME disassembly of the same pair does not look like executable reset/startup code, so treat it as data until proven otherwise.

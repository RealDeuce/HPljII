...
KNOWN_PCL_COMMANDS = {
    ...
    (0x1b, 0x26, 0x6b, 0x53): "Pitch mode",
    ...
    (0x1b, 0x26, 0x64): "Underline/text attribute tokenizer",
    (0x1b, 0x26, 0x64, 0x44): "Underline mode",
    (0x1b, 0x26, 0x6c, 0x57): "Vertical forms control payload",
    (0x1b, 0x2a, 0x74, 0x52): "Raster resolution",
    (0x1b, 0x2a, 0x72, 0x41): "Start raster graphics",
    (0x1b, 0x2a, 0x72, 0x42): "End raster graphics",
    (0x1b, 0x2a, 0x72, 0x4b): "Stateful raster/tokenizer wrapper",
    ...
    (0x1b, 0x2a, 0x63, 0x47): "Area fill id",
    ...
    (0x1b, 0x2a, 0x73, 0x5e): "Stateful raster/tokenizer wrapper",
